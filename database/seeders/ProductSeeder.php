    ...
    public function run(): void
    {
        collect([
            [
                ...
                'category_id' => Category::query()->where('slug', 'shoes')->value('id'),
                'price' => 500000,
            ],
            [
            ...
            [
                ...
                'category_id' => Category::query()->where('slug', 'clothes')->value('id'),
                'price' => 300000,
            ],
            [
            ...
            [
                ...
                'category_id' => Category::query()->where('slug', 'food')->value('id'),
                'price' => 27000,
            ],
        ])->each(function ($product) {
            \App\Models\Product::query()->create($product);
        });
    }
}
